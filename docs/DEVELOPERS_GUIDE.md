...
- Use `applyQualityPalette` and `applyBorderModeToCards` after adding new cards or toggling Border Mode so palette colors and `data-split` corner rings stay accurate.
