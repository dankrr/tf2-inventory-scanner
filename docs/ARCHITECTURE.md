...
A progress toast now uses a rotating Font Awesome spinner to show batch scan status. Its positioning leaves room for the floating controls and clamps width on small screens so long messages remain readable.
