...
- **static/ui.js** – Handles search, filter dropdowns, horizontal scroll helpers, and global density and quality toggles. Exposes `reapplyFilters` for applying saved filters after new items append.
